...
class AsyncPipeline:
    ...
    def set(self, key: str, value: str, ex: Optional[int] = None, px: Optional[int] = None,
    ...
    def lpop(self, key: str, count: Optional[int] = None) -> "AsyncPipeline":
    ...
    def rpop(self, key: str, count: Optional[int] = None) -> "AsyncPipeline":
        if count is not None:
